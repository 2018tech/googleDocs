...
export default class ItemList extends React.Component {
  ...
  onJoin() {
    //everything after ? are query params, they are transferred differently
    //?id=value&title=foo&value=123
    //on the server side, req.query.id would equal that id from client
    //req.query.title, it would equal foo
